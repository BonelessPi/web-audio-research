...
function updateStftNodeParams() {
    periodVal.textContent = `${periodSlider.value} sec`;
    lowVal.textContent = `${lowSlider.value} Hz`;
    highVal.textContent = `${highSlider.value} Hz`;
    if(stftNode){
        stftNode.parameters.get('oscCutoffPeriod').value = parseFloat(periodSlider.value);
        stftNode.parameters.get('oscCutoffLowFreq').value = parseFloat(lowSlider.value);
        stftNode.parameters.get('oscCutoffHighFreq').value = parseFloat(highSlider.value);
    }
}
